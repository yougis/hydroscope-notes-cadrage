...
- fournir les **profils utilisateurs détaillés** (fiches par profil) dans le document de travail dédié [profils_utilisateurs.qmd](./profils_utilisateurs.qmd) et la **matrice des dépendances** entre user stories dans [dependances_us.qmd](./dependances_us.qmd) ;
...
Les fonctionnalités prévu dans le MCP sont identifiés dans la **backlog**, qui sera priorisée au fur et à mesure par la MOA en fonction de la valeur métier et des contraintes techniques comme le préconise la méthodologie Agile (détaillée au [chapitre 7 – Product backlog](#sec-backlog)).