...
Les fonctionnalités prévu dans le MCP sont identifiés dans la **backlog**, qui sera priorisée au fur et à mesure par la MOA en fonction de la valeur métier et des contraintes techniques comme le préconise la méthodologie Agile .