...
@todo[priority=high, section=processing]: indiquer la volumetrie pour les traitements si cela est externalisé.
...
@todo[priority=high, section=API]: préciser les usages des API externe prévues.
