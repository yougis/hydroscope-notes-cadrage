...
Périmètre couvert : les **User Stories à `MVP=TRUE`** du backlog (backlog.xlsx) — EPIC 6 (24 US), EPIC 7 (3 US), EPIC 8 (2 US), EPIC 9 (2 US), EPIC 10 (2 US), soit 33 US. Les conventions suivantes s'appliquent à l'ensemble :
...
### US6.18 — Calculer les communes intersectant un BV (≥ 20 %) pour la facette Commune (IHM NON)
...
*Périmètre MVP — Ce document référence le catalogue des indicateurs (38 indicateurs) et les référentiels (BVAEP, captages, PPE) fournis en données de référence pour la recette en Nouvelle-Calédonie. La liste des US couvertes correspond aux flags `MVP=TRUE` du fichier backlog.xlsx : 33 US au total pour les EPIC 6 à 10, dont 24 pour l'EPIC 6.*
