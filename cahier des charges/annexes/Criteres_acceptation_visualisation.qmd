...
Périmètre couvert : les **User Stories** du ({{< meta fichier_backlog >}}) — EPIC 6 ({{< meta n_us_epic6_mvp >}} US), EPIC 7 ({{< meta n_us_epic7_mvp >}} US), EPIC 8 ({{< meta n_us_epic8_mvp >}} US), EPIC 9 ({{< meta n_us_epic9_mvp >}} US), EPIC 10 ({{< meta n_us_epic10_mvp >}} US), soit {{< meta n_us_mvp_6_10 >}} US. Les conventions suivantes s'appliquent à l'ensemble :
...
### US6.25 — Voir toute la liste des indicateurs ({{< meta n_ind >}}) regroupée Famille → Thème → Groupe
- **Étant donné** le catalogue d'indicateurs complet, **quand** je l'ouvre, **alors** la liste complète ({{< meta n_ind >}} indicateurs) s'affiche, regroupée par Famille → Thème → Groupe avec compteurs.
...
*Périmètre MVP — Ce document référence le catalogue des indicateurs ({{< meta n_ind >}} indicateurs) et les référentiels (BVAEP, captages, PPE) fournis en données de référence pour la recette en Nouvelle-Calédonie. La liste des US couvertes correspond à l'attribut `MVP=TRUE` du fichier {{< meta fichier_backlog >}} : {{< meta n_us_mvp_6_10 >}} US au total pour les EPIC 6 à 10, dont {{< meta n_us_epic6_mvp >}} pour l'EPIC 6.*
