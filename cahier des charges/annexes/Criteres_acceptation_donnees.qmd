...
#### US1.1 — Importer des données via fichier (IHM)
...
#### US1.3 — Planifier des imports simples 
...
#### US1.5 — Gérer les erreurs d'import (IHM)
...
#### US1bis.1 — Enregistrer un jeu de données dans le catalogue (IHM)
...
#### US1bis.2 — Associer des métadonnées à un jeu de données (IHM)
...
#### US1bis.4 — Consulter les informations d'un jeu de données (IHM)
...
#### US1bis.7 — Visualiser les relations entre indicateur et données sources (IHM)
...
#### US1bis.10 — Alimenter automatiquement le catalogue lors des imports
...
#### US1bis.12 — Enregistrer un indicateur comme donnée dérivée (IHM)
...
#### US2.1 — Détecter des valeurs aberrantes 
...
#### US2.4 — Calculer un taux de complétude
...
#### US2.6 — Associer des métadonnées de qualité (IHM)
...
#### US3.1 — Gérer les bassins versants (BVAEP) (IHM)
...
#### US3.5 — Définir un indicateur (IHM)
...
#### US4.1 — Calculer des indicateurs simples
