...
- **Méthode de scoring** : le scoring conservateur « déclassant » (la classe la plus pénalisante détermine le niveau) est une possibilité ; il reste à valider avec la MOA et le conseil scientifique avant son intégration (point ouvert MOA).
