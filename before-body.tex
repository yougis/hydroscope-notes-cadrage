...
% intégration des titre, sous-titre, auteurs et date
    ...
    \begin{minipage}[1cm]{16cm}
        \begin{adjustwidth}{-0.4cm}{1cm} 
            \vspace{3.4cm}
            \begin{tikzpicture}[remember picture,overlay]
                \node [inner sep=0pt] at (12.5cm,-5cm) {\includegraphics[width=7cm,height=1.5cm]{$logo_partenaire$} 
            };
            \end{tikzpicture}
            {\fontsize{11}{13}\selectfont
            \color{version_color}
            \\ $diffusion$ \\ Nouvelle-Calédonie\\  % ou Logo partenaire/prestataire H, 5.5cm
            }
        \end{adjustwidth}
    \end{minipage}
