...
- **Réponse** : Adoption d’un socle open source et mise en place d’une historisation réfléchie des données et indicateurs prioritaires, avec un catalogage et une documentation systématiques des procédures.
