...
Le système pourra utiliser des mécanismes de stockage côté navigateur (cookies, stockage local) afin de gérer les sessions utilisateurs et de mémoriser certains paramètres d’usage (préférences, filtres, état de navigation).
