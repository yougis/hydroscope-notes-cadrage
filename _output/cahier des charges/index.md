...
Les principales sources de données mobilisées sont les suivantes :
  ...
  ------------------------------ ------------- -------------- ------------------------------------------------------------------------------------- ------------
  Espèces envahissantes          ANCB          patrick        Pas d'accès API                                                                       Disponible
                                               Barrière ANCB                                                                                        

  Forêt sèche -- Indices de      CEN           GEOREP         GEOREP (plateforme web)                                                               Disponible
  vulnérabilité                                                                                                                                     

  Zones clés de biodiversité     CEN           GEOREP         GEOREP (plateforme web)                                                               Disponible
  (KBA -- Key Biodiversity                                                                                                                          
  Areas)                                                                                                                                            

  zones inscrites au patrimoine  CEN           GEOREP         GEOREP (plateforme web)                                                               Disponible
  mondial de l'UNESCO                                                                                                                               

  unité de distribution (nom à   DASS          nan            Pas d'accès API                                                                       Interne
  vérifier)                                                                                                                                         
  ...
  Base de données du sous-sol de DAVAR         GEOREP         GEOREP (plateforme web)                                                               Disponible
  NC (BDSSNC) -- forages et                                                                                                                         
  hydrogéologie                                                                                                                                     

  Bilan Besoin Ressource         DAVAR         GEOREP         https://www.arcgis.com/home/item.html?id=6d48f295daf5471a842054d9e050765d             Disponible

  Captages d'eau                 DAVAR         GEOREP         GEOREP (plateforme web)                                                               Disponible

  Franchissement du réseau       DAVAR         nan            Pas d'accès API                                                                       A vérifier
  hydrographique des BVAEP (nom                                                                                                                     
  à vérifier)                                                                                                                                       

  Hydrométrie -- Stations DAVAR  DAVAR         GEOREP         GEOREP (plateforme web)                                                               Disponible
  / Bassins versants aux                                                                                                                            
  limnimètres                                                                                                                                       

  Périmètres de protection des   DAVAR         GEOREP         GEOREP (plateforme web)                                                               Disponible
  eaux                                                                                                                                              

  BDLISA-NC - Vulnérabilité      DIMENC        GEOREP         GEOREP (plateforme web)                                                               Disponible
  intrinsèque des eaux                                                                                                                              
  souterraines (gdb)                                                                                                                                

  Compilation des cartographies  DIMENC        GEOREP         https://dtsi-sgt.maps.arcgis.com/home/item.html?id=c472c49f798046b9b2c716c83523c324   Disponible
  d'aléa mouvement de terrain                                                                                                                       
  communal à l'échelle 1:25                                                                                                                         
  000ème.                                                                                                                                           

  Exploitation minière en        DIMENC        GEOREP         https://dtsi-sgt.maps.arcgis.com/home/item.html?id=4e485fd6879142d9b52fe1bcea0c2cb1   Disponible
  Nouvelle-Calédonie : centres                                                                                                                      
  miniers et usines                                                                                                                                 
  métallurgiques                                                                                                                                    

  Géologie au 1/200 000e --      DIMENC        GEOREP         GEOREP (plateforme web)                                                               Disponible
  DIMENC/SGNC-BRGM 1981                                                                                                                             

  Géologie au 1/50 000e --       DIMENC        GEOREP         GEOREP (plateforme web)                                                               Disponible
  DIMENC/SGNC-BRGM 2013                                                                                                                             

  Installations Classées pour la DIMENC        GEOREP         GEOREP (plateforme web)                                                               Disponible
  Protection de l'Environnement                                                                                                                     

  cadastre minier actif          DIMENC        GEOREP         https://dtsi-sgt.maps.arcgis.com/home/item.html?id=e70295d0f4994702ad2d64e6c4156377   Disponible
  (concessions, permis de                                                                                                                           
  recherches et réserves                                                                                                                            
  techniques provinciales) et                                                                                                                       
  échu                                                                                                                                              
  ...
  Occupation du sol (dynamique   Dynamic World GEE            GEE API                                                                               Disponible
  world v1)                      V1                                                                                                                 

  Espèces rares et menacées (nom Endemia       ENDEMIA        À confirmer                                                                           Disponible
  à vérifier)                                                                                                                                       

  Typologie de l'habitat         ISEE          ISEE           Convention requise                                                                    Disponible

  Pluviométrie -- Stations Météo Météo France  GEOREP         GEOREP (plateforme web)                                                               Disponible
  France                                                                                                                                            

  Cartographie des formes        OEIL          OEIL           GEOREP (plateforme web)                                                               Disponible
  érosives en Province Sud                                                                                                                          

  Zones potentiellement brulées  OEIL          OEIL           GEOREP (plateforme web)                                                               Disponible
  (VIIRS)                                                                                                                                           

  CARTOGRAPHIE -- OCCUPATION DES OEIL/GOUV     GEOREP         GEOREP (plateforme web)                                                               Disponible
  SOLS (MOS 2014 -- classes                                                                                                                         
  végétation)                                                                                                                                       

  Aires protégées de la Province PIL           PIL            À confirmer                                                                           A vérifier
  des Iles                                                                                                                                          

  Installations Classées pour la PIL           PIL            À confirmer                                                                           A vérifier
  Protection de l'Environnement                                                                                                                     
  de la Province des Iles                                                                                                                           

  Aires protégées de la Province PNORD         PNORD          À confirmer                                                                           Disponible
  Nord                                                                                                                                              

  Installations Classées pour la PNORD         PNORD          À confirmer                                                                           A vérifier
  Protection de l'Environnement                                                                                                                     
  de la Province Nord                                                                                                                               

  PUD des communes de la         PNORD         PNORD          Pas d'accès API                                                                       A vérifier
  province Nord                                                                                                                                     

  Aires protégées de la Province PSUD          PSUD           PSUD Open Data                                                                        Disponible
  Sud                                                                                                                                               

  Installations Classées pour la PSUD          PSUD           PSUD Open Data                                                                        Disponible
  Protection de l'Environnement                                                                                                                     
  de la Province Sud                                                                                                                                

  PUD des communes de la         PSUD          PSUD           PSUD Open Data                                                                        Disponible
  province SUD                                                                                                                                      

  Cartographie des surfaces      TMF           GEE            https://forobs.jrc.ec.europa.eu/TMF                                                   Disponible
  forestières de                                                                                                                                    
  Nouvelle-Calédonie                                                                                                                                
